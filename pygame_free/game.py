...
class EscenaNivel1(Escena):
    ...
    def leer_eventos(self, eventos):
        for evento in eventos:
            if evento.type == pygame.KEYDOWN:
                ...
                if (self.esperando_saque is True and
    ...
    def mostrar_puntuacion(self, pantalla):
        ...
        texto = fuente.render(str(self.puntuacion).zfill(5),
                              True, color_blanco)
...
class EscenaJuegoTerminado(Escena):
    ...
    def dibujar(self, pantalla):
        ...
        texto = fuente.render('Muerte Activada :(', True, color_blanco)
        texto_rect = texto.get_rect()
...
class Bolita(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Cargar imagen
        self.image = pygame.image.load('static/img/bolita.png')
...
class Paleta(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('static/img/paleta.png')
        # Obtener rectángulo de la imagen
        self.rect = self.image.get_rect()
...
class Ladrillo(pygame.sprite.Sprite):
    def __init__(self, posicion):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('static/img/ladrillo.png')
        # Obtener rectángulo de la imagen
        self.rect = self.image.get_rect()
